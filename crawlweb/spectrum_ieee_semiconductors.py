...
def spectrum_ieee_semiconductors_scrape():
    result = []
    target_root = "http://spectrum.ieee.org/semiconductors"
    url = "http://spectrum.ieee.org/semiconductors"
    article_list = []
    time_list = []
    link_list = []
    content_list = []
    ...
    # print(result)
    return result
# spectrum_ieee_semiconductors_scrape()
