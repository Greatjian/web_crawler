...
def spectrum_ieee_transportation_scrape():
    result = []
    target_root = "http://spectrum.ieee.org/transportation"
    url = "http://spectrum.ieee.org/transportation"
    article_list = []
    time_list = []
    link_list = []
    content_list = []
    ...
    # print(result)
    return result
# spectrum_ieee_transportation_scrape()
